...
import { EspacioComplementarioService } from './espaciocomplementario.service';
import { EspacioComplementario } from '../models/espaciocomplementario';
import { AUTH } from '../auth/auth.constants';

describe('EspacioComplementarioService', () => {
  let service: EspacioComplementarioService;
  let httpMock: HttpTestingController;
  const api = `${AUTH.API}/espacioscomplementarios`;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(EspacioComplementarioService);
