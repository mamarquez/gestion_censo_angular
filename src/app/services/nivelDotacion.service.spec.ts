...
import { NivelDotacionService } from './nivelDotacion.service';
import { NivelDotacion } from '../models/niveldotacion';
import { AUTH } from '../auth/auth.constants';

describe('NivelDotacionService', () => {
  let service: NivelDotacionService;
  let httpMock: HttpTestingController;
  const api = `${AUTH.API}/nivelesdotaciones`;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(NivelDotacionService);
