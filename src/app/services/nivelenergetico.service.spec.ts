...
import { NivelEnergeticoService } from './nivelenergetico.service';
import { NivelEnergetico } from '../models/nivelenergetico';
import { AUTH } from '../auth/auth.constants';

describe('NivelEnergeticoService', () => {
  let service: NivelEnergeticoService;
  let httpMock: HttpTestingController;
  const api = `${AUTH.API}/nivelesenergeticos`;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(NivelEnergeticoService);
