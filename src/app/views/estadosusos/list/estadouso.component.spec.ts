...
describe('EstadoUsoComponent', () => {
  ...
  const crearEstadosUsosMock = (): EstadoUso[] => [
  ...
  beforeEach(async () => {
    estadosUsosMock = crearEstadosUsosMock();
    ...
    serviceSpy.getAll.and.returnValue(of(respuesta(estadosUsosMock)));
  ...
  it('se crea correctamente y carga el listado en ngOnInit', () => {
    ...
    expect(component.estadosUsos).toHaveSize(2);
  ...
  it('cambiarEstado() invierte el estado activo del estado de uso afectado', () => {
    fixture.detectChanges();
  ...
  it('confirmarBorrado() delega en DialogService con el nombre del estado de uso', () => {
    fixture.detectChanges();
    const estadoUso = component.estadosUsos.find(e => e.id === 1)!;

    component.confirmarBorrado(estadoUso);
  ...
  it('abrirModal() limpia el estado de uso seleccionado y abre el modal', () => {
    fixture.detectChanges();
    component.estadoUso = estadosUsosMock[0];
  ...
  it('editar() carga el estado de uso y abre el modal', () => {
    fixture.detectChanges();
    serviceSpy.get.and.returnValue(of(respuesta(estadosUsosMock[0])));

    component.editar('1');

    expect(serviceSpy.get).toHaveBeenCalledWith('1');
    expect(component.estadoUso).toEqual(estadosUsosMock[0]);
    expect(component.modalVisible).toBeTrue();
  });
