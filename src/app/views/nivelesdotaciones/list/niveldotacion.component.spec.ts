...
describe('NivelDotacionComponent', () => {
  ...
  beforeEach(async () => {
    nivelesDotacionesMock = crearNivelesDotacionesMock();
    ...
    serviceSpy.getAll.and.returnValue(of(respuesta(nivelesDotacionesMock)));
  ...
  it('se crea correctamente y carga el listado en ngOnInit', () => {
    ...
    expect(component.nivelesDotaciones).toHaveSize(2);
  ...
  it('cambiarEstado() invierte el estado activo del nivel de dotación afectado', () => {
    fixture.detectChanges();
  ...
  it('confirmarBorrado() delega en DialogService con el nombre del nivel de dotación', () => {
    fixture.detectChanges();
    const nivelDotacion = component.nivelesDotaciones.find(n => n.id === 1)!;

    component.confirmarBorrado(nivelDotacion);
  ...
  it('abrirModal() limpia el nivel de dotación seleccionado y abre el modal', () => {
    fixture.detectChanges();
    component.nivelDotacion = nivelesDotacionesMock[0];
  ...
  it('editar() carga el nivel de dotación y abre el modal', () => {
    fixture.detectChanges();
    serviceSpy.get.and.returnValue(of(respuesta(nivelesDotacionesMock[0])));

    component.editar('1');

    expect(serviceSpy.get).toHaveBeenCalledWith('1');
    expect(component.nivelDotacion).toEqual(nivelesDotacionesMock[0]);
    expect(component.modalVisible).toBeTrue();
  });
