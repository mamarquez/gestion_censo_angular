...
describe('NivelEducativoComponent', () => {
  ...
  const crearNivelesEducativosMock = (): NivelEducativo[] => [
  ...
  let nivelesEducativosMock: NivelEducativo[];
  ...
  beforeEach(async () => {
    nivelesEducativosMock = crearNivelesEducativosMock();
    ...
    serviceSpy.getAll.and.returnValue(of(respuesta(nivelesEducativosMock)));
  ...
  it('se crea correctamente y carga el listado en ngOnInit', () => {
    ...
    expect(component.nivelesEducativos).toHaveSize(2);
  ...
  it('cambiarEstado() invierte el estado activo del nivel educativo afectado', () => {
    fixture.detectChanges();
  ...
  it('confirmarBorrado() delega en DialogService con el nombre del nivel educativo', () => {
    fixture.detectChanges();
    const nivelEducativo = component.nivelesEducativos.find(n => n.id === 1)!;

    component.confirmarBorrado(nivelEducativo);
  ...
  it('abrirModal() limpia el nivel educativo seleccionado y abre el modal', () => {
    fixture.detectChanges();
    component.nivelEducativo = nivelesEducativosMock[0];
  ...
  it('editar() carga el nivel educativo y abre el modal', () => {
    fixture.detectChanges();
    serviceSpy.get.and.returnValue(of(respuesta(nivelesEducativosMock[0])));

    component.editar('1');

    expect(serviceSpy.get).toHaveBeenCalledWith('1');
    expect(component.nivelEducativo).toEqual(nivelesEducativosMock[0]);
    expect(component.modalVisible).toBeTrue();
  });
