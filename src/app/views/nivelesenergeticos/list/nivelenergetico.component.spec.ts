...
describe('NivelEnergeticoComponent', () => {
  ...
  beforeEach(async () => {
    nivelesEnergeticosMock = crearNivelesEnergeticosMock();
    ...
    serviceSpy.getAll.and.returnValue(of(respuesta(nivelesEnergeticosMock)));
  ...
  it('se crea correctamente y carga el listado en ngOnInit', () => {
    ...
    expect(component.nivelesEnergeticos).toHaveSize(2);
  ...
  it('cambiarEstado() invierte el estado activo del nivel energético afectado', () => {
    fixture.detectChanges();
  ...
  it('confirmarBorrado() delega en DialogService con el nombre del nivel energético', () => {
    fixture.detectChanges();
    const nivelEnergetico = component.nivelesEnergeticos.find(n => n.id === 1)!;

    component.confirmarBorrado(nivelEnergetico);
  ...
  it('abrirModal() limpia el nivel energético seleccionado y abre el modal', () => {
    fixture.detectChanges();
    component.nivelEnergetico = nivelesEnergeticosMock[0];
  ...
  it('editar() carga el nivel energético y abre el modal', () => {
    fixture.detectChanges();
    serviceSpy.get.and.returnValue(of(respuesta(nivelesEnergeticosMock[0])));

    component.editar('1');

    expect(serviceSpy.get).toHaveBeenCalledWith('1');
    expect(component.nivelEnergetico).toEqual(nivelesEnergeticosMock[0]);
    expect(component.modalVisible).toBeTrue();
  });
