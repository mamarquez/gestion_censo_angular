...
describe('ListCentroEducativoComponent', () => {
  ...
  beforeEach(async () => {
    centrosEducativosMock = crearCentrosEducativosMock();
    ...
    serviceSpy.getAll.and.returnValue(of(respuesta(centrosEducativosMock)));
  ...
  it('se crea correctamente y carga el listado en ngOnInit', () => {
    ...
    expect(component.centrosEducativos).toHaveSize(2);
  ...
  it('cambiarEstado() invierte el estado activo del centro educativo afectado', () => {
    fixture.detectChanges();
  ...
  it('confirmarBorrado() delega en DialogService con el nombre del centro educativo', () => {
    fixture.detectChanges();
    const centroEducativo = component.centrosEducativos.find(c => c.id === 1)!;

    component.confirmarBorrado(centroEducativo);
  ...
  it('abrirModal() limpia el centro educativo seleccionado y abre el modal', () => {
    fixture.detectChanges();
    component.centroEducativo = centrosEducativosMock[0];
  ...
  it('editar() carga el centro educativo y abre el modal', () => {
    fixture.detectChanges();
    serviceSpy.get.and.returnValue(of(respuesta(centrosEducativosMock[0])));

    component.editar('1');

    expect(serviceSpy.get).toHaveBeenCalledWith('1');
    expect(component.centroEducativo).toEqual(centrosEducativosMock[0]);
    expect(component.modalVisible).toBeTrue();
  });
