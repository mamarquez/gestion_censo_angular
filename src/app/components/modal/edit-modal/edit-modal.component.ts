...
import { SelectDeportivoComponent } from '../../select-deportivo/select-deportivo.component';
    ...
    effect(() => {
      ...
      if (datos) {
        this.form.patchValue({
          ...
          tipoInstalacion: datos.tipoInstalacion?.id ?? null
        });
      } else {
        this.form.reset({
          id: null,
